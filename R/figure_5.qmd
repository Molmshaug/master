...
final_dataset <- bind_rows(vo2_pre, vo2_postphle) %>% 
  ...
  filter(!id %in% c(18, 19, 22, 23, 29, 35, 37, 38, 50, 51, 52, 54, 56, 57, 58))
...
combined_plot <- combined_plot +
  ...
  plot_annotation(subtitle = "Participants that removed blood")
...
est6 <- emmeans(per_mod, specs = ~ timepoint)
summary(est6)
pairs(est6)
